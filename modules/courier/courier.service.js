...
async function banCourierService(req, res) {
    ...
    try {
        ...
        await courierProfile.update({ status: "banned" })
        response = {
            success: true,
            message: "Ce livreur a été banni",
            data: courierProfile.user
        }
...
async function suspendCourierService(req, res) {
    ...
    try {
        ...
        await courierProfile.update({ status: "suspended" })
        response = {
            success: true,
            message: "Ce livreur a été suspendu",
            data: courierProfile.user
        }
...
async function activateCourierService(req, res) {
    ...
    try {
        ...
        await courierProfile.update({ status: "active" })
        response = {
            success: true,
            message: "Ce livreur est de nouveau actif",
            data: courierProfile.user
        }
...
async function deactivateCourierService(req, res) {
    ...
    try {
        ...
        await courierProfile.update({ status: "inactive" })
        response = {
            success: true,
            message: "Ce livreur a été désactivé",
            data: courierProfile.user
        }
